    ...
    execute(request, chatHistory) {
        return __asyncGenerator(this, arguments, function* execute_1() {
            ...
            const aggregateQuestion = [
                ...
                .filter(Boolean)
                .join('\n\n');
            const agentOptions = new agent_1.AgentOptions(question, aggregateQuestion, request.userOptions, (chatHistory === null || chatHistory === void 0 ? void 0 : chatHistory.map((message) => message.content)) || [], projectInfo, codeSelection, contextLabels);
            ...
            if (request.prompt) {
                this.interactionHistory.addEvent(new interaction_history_1.PromptInteractionEvent('customPrompt', 'system', request.prompt));
            }
            if (codeSelection)
