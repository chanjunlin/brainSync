...
exports.GENERATE_AGENT_FORMAT = exports.GENERATE_AGENT_PROMPT = void 0;
...
`;
exports.GENERATE_AGENT_FORMAT = `**Response Format**
...
`;
class GenerateAgent {
    constructor(history, contextService) {
    ...
    perform(options, tokensAvailable) {
        return __awaiter(this, void 0, void 0, function* () {
            const agentPrompt = [exports.GENERATE_AGENT_PROMPT];
            ...
            if (options.userOptions.isEnabled('format', true)) {
                agentPrompt.push(exports.GENERATE_AGENT_FORMAT);
            }
            this.history.addEvent(new interaction_history_1.PromptInteractionEvent('agent', 'system', agentPrompt.join('\n\n')));
            ...
            yield this.contextService.perform(options, tokensAvailable);
        });
    }
