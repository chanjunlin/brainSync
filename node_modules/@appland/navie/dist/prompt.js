...
exports.buildPromptValue = exports.buildPromptDescriptor = exports.PROMPTS = exports.PromptType = void 0;
var PromptType;
(function (PromptType) {
    PromptType["Question"] = "question";
    PromptType["IssueDescription"] = "issueDescription";
    PromptType["ProblemStatement"] = "problemStatement";
    PromptType["CodeSelection"] = "codeSelection";
    PromptType["AppMapConfig"] = "appmapConfig";
    PromptType["AppMapStats"] = "appmapStats";
    PromptType["SequenceDiagram"] = "sequenceDiagrams";
    PromptType["CodeSnippet"] = "codeSnippets";
    PromptType["DataRequest"] = "dataRequest";
    PromptType["HelpDoc"] = "helpDoc";
    PromptType["CodeEditor"] = "codeEditor";
...
function buildPromptDescriptor(promptType) {
    const prompt = exports.PROMPTS[promptType];
    const content = [prompt.content];
    if (prompt.multiple) {
        content.push(`Multiple ${PROMPT_NAMES[promptType].plural} of this type will be provided. Each one will be prefixed with "[${prompt.tagName}]"`);
    }
    else {
        content.push(`The ${PROMPT_NAMES[promptType].singular} will be prefixed with "[${prompt.tagName}]"`);
    }
    return content.join('\n\n');
}
exports.buildPromptDescriptor = buildPromptDescriptor;
function buildPromptValue(promptType, value) {
    const prompt = exports.PROMPTS[promptType];
    return [`<${prompt.tagName}>`, value, `</${prompt.tagName}>`].join('\n');
}
exports.buildPromptValue = buildPromptValue;
