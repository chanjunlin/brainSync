...
const content_after_1 = __importDefault(require("../lib/content-after"));
    ...
    suggestTerms(question) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let searchTermsObject;
            {
                ...
                responseText = (0, content_after_1.default)(responseText, 'Terms:');
                searchTermsObject =
                    (0, parse_json_1.default)(responseText, undefined) ||
