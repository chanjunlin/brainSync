...
class LookupContextService {
    ...
    lookupContext(keywords, tokenCount, filters = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            if (keywords.length === 0) {
                (0, console_1.warn)('WARNING: No keywords provided');
                return [];
            }
            const contextRequestPayload = Object.assign({ version: 2, type: 'search', vectorTerms: keywords, tokenCount }, filters);
            const context = yield this.contextFn(contextRequestPayload);
            const contextFound = (context === null || context === void 0 ? void 0 : context.length) > 0;
            if (contextFound) {
                this.interactionHistory.addEvent(new interaction_history_1.ContextLookupEvent(context));
            }
            else {
                (0, console_1.warn)('No context found');
    ...
    lookupHelp(languages, vectorTerms, tokenCount) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (helpFound) {
                ...
                (0, console_1.warn)('No help found');
