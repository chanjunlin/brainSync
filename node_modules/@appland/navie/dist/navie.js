...
exports.NavieOptions = exports.DEFAULT_RESPONSE_TOKENS = exports.DEFAULT_TEMPERATURE = exports.DEFAULT_TOKEN_LIMIT = exports.DEFAULT_MODEL_NAME = void 0;
...
const context_command_1 = __importDefault(require("./commands/context-command"));
const apply_command_1 = __importDefault(require("./commands/apply-command"));
const file_change_extractor_service_1 = __importDefault(require("./services/file-change-extractor-service"));
const file_update_service_1 = __importDefault(require("./services/file-update-service"));
const parse_options_1 = __importDefault(require("./lib/parse-options"));
const list_files_command_1 = __importDefault(require("./commands/list-files-command"));
const console_1 = require("console");
exports.DEFAULT_MODEL_NAME = 'gpt-4o';
exports.DEFAULT_TOKEN_LIMIT = 8000;
exports.DEFAULT_TEMPERATURE = 0.2;
exports.DEFAULT_RESPONSE_TOKENS = 1000;
class NavieOptions {
    constructor() {
        var _a, _b, _c, _d;
        this.modelName = (_a = process.env.APPMAP_NAVIE_MODEL) !== null && _a !== void 0 ? _a : exports.DEFAULT_MODEL_NAME;
        ...
        this.responseTokens = Number((_d = process.env.APPMAP_NAVIE_RESPONSE_TOKENS) !== null && _d !== void 0 ? _d : exports.DEFAULT_RESPONSE_TOKENS);
    }
}
...
function navie(clientRequest, contextProvider, projectInfoProvider, helpProvider, options, chatHistory) {
    if (options.modelName !== exports.DEFAULT_MODEL_NAME)
        (0, console_1.warn)(`Using model ${options.modelName}`);
    if (options.tokenLimit !== exports.DEFAULT_TOKEN_LIMIT)
        (0, console_1.warn)(`Using token limit ${options.tokenLimit}`);
    if (options.temperature !== exports.DEFAULT_TEMPERATURE)
        (0, console_1.warn)(`Using temperature ${options.temperature}`);
    if (options.responseTokens !== exports.DEFAULT_RESPONSE_TOKENS)
        (0, console_1.warn)(`Using response tokens ${options.responseTokens}`);
    ...
    const fileChangeExtractor = new file_change_extractor_service_1.default(interactionHistory, options.modelName, options.temperature);
    const fileUpdateService = new file_update_service_1.default(interactionHistory);
    ...
    const buildListFileCommand = () => new list_files_command_1.default(fileChangeExtractor);
    const buildContextCommand = () => new context_command_1.default(options, vectorTermsService, lookupContextService);
    const buildApplyCommand = () => new apply_command_1.default(fileChangeExtractor, fileUpdateService);
    const commandBuilders = {
        [command_1.CommandMode.Explain]: buildExplainCommand,
        [command_1.CommandMode.Classify]: buildClassifyCommand,
        [command_1.CommandMode.ListFiles]: buildListFileCommand,
        [command_1.CommandMode.VectorTerms]: buildVectorTermsCommand,
        [command_1.CommandMode.TechStack]: buildTechStackCommand,
        [command_1.CommandMode.Context]: buildContextCommand,
        [command_1.CommandMode.Apply]: buildApplyCommand,
    };
    ...
    const { options: userOptions, question: questionText } = (0, parse_options_1.default)(question);
    ...
    class Navie extends events_1.default {
        ...
        execute() {
            return __asyncGenerator(this, arguments, function* execute_1() {
                ...
                yield __await(yield* __asyncDelegator(__asyncValues(command.execute(Object.assign(Object.assign({}, clientRequest), { userOptions }), chatHistory))));
            });
        }
    }
    return new Navie();
